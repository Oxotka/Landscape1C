...
- [ ] **Step 9: Задеплоить на VPS и проверить телеграм-бота живьём**

Это единственный шаг таска, который трогает боевой сервер — делать после того, как Step 6 и 7 зелёные локально.
