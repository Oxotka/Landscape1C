...
Самый простой путь — формы: [предложить инструмент](../../issues/new?template=add-tool.yml) или [исправить карточку](../../issues/new?template=fix-card.yml). Критерии включения, процесс и правила для Pull Request — в [CONTRIBUTING.md](CONTRIBUTING.md).
