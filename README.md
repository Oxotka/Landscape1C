...
**Опрос 2026 уже идёт в Telegram и MAX.** Основная волна открыта 29 августа, отсечка запланирована на 1 октября 2026 года. [Участвовать и посмотреть предварительные итоги](https://landscape1c.ru/survey2026).

На сайте опубликованы промежуточные результаты текущего опроса и метрики в карточках инструментов. Снимок от 10 сентября: 280 участников, 202 инструмента; еще 13 инструментов дополнены июльскими результатами с пометкой источника.

Ближайшие задачи — завершить сбор, проверить данные и подготовить «Итоги 2026» в октябре–ноябре: аналитический материал на странице опроса, обновлённые метрики и обезличенный датасет. Подробности и принятые решения — в [docs/TZ.md](docs/TZ.md).
