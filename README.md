...
На сайте опубликованы результаты предварительного этапа — 247 участников; это отдельный срез, а не текущий счётчик основной волны. Метрики этого этапа также показаны на карточках инструментов.
